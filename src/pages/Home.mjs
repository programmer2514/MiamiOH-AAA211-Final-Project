...
export default function Home({ page, setPage, className }) {
  ...
  return (
    ...
    >
      ...
      <h1 id="h1" className="text-white text-[6vmax] w-[49vmax] max-w-full m-8 font-extrabold leading-normal drop-shadow-2xl portrait:text-[4vmax] portrait:w-[33vmax]">
      ...
      <div className="m-8 w-[25vmax] max-w-full text-center -translate-y-[2.75vmax]">
        ...
        <p
          id="p"
          className="text-[2vmax] translate-x-[3.25vmax] translate-y-[8.25vmax] absolute leading-tight font-bold z-10 text-4xl w-[20vmax] max-w-full text-[#181818]"
        ...
        <img
          id="bg"
          className="scale-y-[60%] translate-y-[2.75vmax]"
          src={ImageBackground}
          role="presentation"
          alt=""
        />
        ...
        <a
          id="a"
          className="text-2xl drop-shadow-xl after:block after:h-[2px] after:content-[''] after:-bottom-4 after:left-1/2 after:relative after:bg-[#fcb800] after:transition-all after:duration-200 after:w-0 hover:after:w-1/2 hover:after:left-1/4 focus-visible:after:w-1/2 focus-visible:after:left-1/4"
          href="#resources"
